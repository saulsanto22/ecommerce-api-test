...
class WebhookController extends Controller
{
    ...
    {
        Log::info('ðŸ”” Payment Webhook Received', $request->all());
        ...
        try {
            ...
            if (! $payment) {
                Log::error('âŒ Payment not found for webhook', ['payment_id' => $validated['id']]);
                DB::rollBack();
            ...
            if ($validated['status'] === 'PAID') {
                ...
                Log::info('âŒ Payment expired, order cancelled', [
                    'order_number' => $payment->order->order_number,
                ]);
            }
            ...
            Log::info('ðŸŽ‰ Webhook processed successfully', [
                'payment_id' => $validated['id'],
                'status' => $validated['status'],
